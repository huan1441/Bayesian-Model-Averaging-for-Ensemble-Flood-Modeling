# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#
# Purpose: Sampling water stage predictions based on BMA parameters (Normal PDF)
#
# Created by Tao Huang, July, 2021
#
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
for i in range(T):
    ...
    for j in range(Size):
        ...
        BMA_sample[i,j] = np.random.normal(loc=f_high[i,sample_model_no[j]], scale=sigma[sample_model_no[j]], size=1)
